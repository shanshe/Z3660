...
#endif
//   printf("num_kickstarts %d num_ext_kickstarts %d\n",num_kickstarts,num_ext_kickstarts);
   scsis[0][0]='D';
   scsis[0][1]='i';
   scsis[0][2]='s';
   scsis[0][3]='a';
