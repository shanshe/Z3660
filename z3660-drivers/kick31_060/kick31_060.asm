...
P5BARS		EQU	1	;if set=1, then show green-blue bars at boot
				;(much like P5 boards)
EXPANSION_MANUF	EQU	2588	;A1k.org (set = 0 to disable software-based 
				;expansion ID)
EXPANSION_ID	EQU	$3c	;BFG9060=60
...
ExpansionIDInitFunc:
	...
	move.l	d0,a0
        ...
        move.l  #$f00000,cd_BoardAddr(a0)            ;BootROM address
        move.l  #$80000,cd_BoardSize(a0)             ;proud 512k ROM
        move.b  #ERT_ZORROIII+1,cd_Rom+er_Type(a0)   ;well hmm, not really :-)
...
ExpansionIDName:	dc.b	"BFG9060",10,0
ExpansionIDName2:	dc.b	"BFG9060 ROM 1.2",10,0
