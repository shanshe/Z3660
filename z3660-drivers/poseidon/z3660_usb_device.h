...
/* Port change event flags (matching ARM side) */
#define USB_STATUS_PORT_CHANGE  0x0020  /* Generic port change detected */
#define USB_STATUS_DEVICE_CONNECT    0x0040  /* Device connected */
#define USB_STATUS_DEVICE_DISCONNECT 0x0080  /* Device disconnected */
...
struct Z3660USBUnit {
    ...
    ULONG                        arm_int_signal;       /* Signal for interrupt transfer data ready */
    struct Task                 *waiting_task;         /* Task waiting for interrupt signal */
