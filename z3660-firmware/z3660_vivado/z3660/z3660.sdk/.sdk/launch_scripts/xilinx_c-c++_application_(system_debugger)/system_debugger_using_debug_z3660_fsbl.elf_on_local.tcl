...
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Platform Cable USB 0000135e63f001"} -index 0
rst -system
after 3000
targets -set -filter {jtag_cable_name =~ "Platform Cable USB 0000135e63f001" && level==0} -index 1
...
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Platform Cable USB 0000135e63f001"} -index 0
