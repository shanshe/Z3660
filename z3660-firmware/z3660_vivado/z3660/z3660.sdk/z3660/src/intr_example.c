...
#define GPIO_CHANNEL_INT_MASK		2
 ...
 */
#define LED_CHANNEL	 1	/* Channel 1 of the GPIO Device */
#define BUTTON_CHANNEL	 2	/* Channel 2 of the GPIO Device */
...
int main_intr(void)
{
	...
	Status = GpioIntrExample(&Intc, &Gpio,
			...
			GPIO_CHANNEL_INT_MASK, &DataRead);
/*
	if (Status == 0 ){
		if(DataRead == 0)
