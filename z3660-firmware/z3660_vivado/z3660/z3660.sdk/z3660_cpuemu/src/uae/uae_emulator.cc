...
addrbank rtg_bank = {
		...
		(uae_u8*)0x18000000, // baseaddr_direct_r
		(uae_u8*)0x18000000, // baseaddr_direct_w
		0x18000000, // startaccessmask
};
addrbank dmmy_bank = {
...
{
	RANGE_MAP(0x5000,0x5020,slow_bank); // RTG Registers
...
//	regs.natmem_offset=(uae_u8*)0x08000000;
	...
	RANGE_MAP(0x00DC,0x00E0,mobo_bank); // Mother Board bank ( RTC, SCSI, Mobo Resources & Custom chips)
	...
	RANGE_MAP(0xFF00,0xFF01,auto_bank); // Slow bank ( Z3660 and Z3 AutoConfig )
