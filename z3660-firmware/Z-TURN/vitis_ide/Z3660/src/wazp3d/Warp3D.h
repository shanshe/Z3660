...
typedef struct
{
    ...
    W3D_Bool reserved3;
    struct MinList restex;      /* A list of all resident textures, used for LRU implementation */
    struct MinList tex;         /* A list of all textures which are not on card */
