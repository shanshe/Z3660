...
char *zz_reg_offsets_string[]={
   ...
   [REG_ZZ_RESERVED_1AC   ] = STRINGIZER(REG_ZZ_RESERVED_1AC   ),// 0x1A8,

   [REG_ZZ_USB_CMD_OP     ] = STRINGIZER(REG_ZZ_USB_CMD_OP     ),// 0x1B0,
   [REG_ZZ_USB_STATUS     ] = STRINGIZER(REG_ZZ_USB_STATUS     ),// 0x1B4,
   [REG_ZZ_USB_RESERVED0  ] = STRINGIZER(REG_ZZ_USB_RESERVED0  ),// 0x1B8,
   [REG_ZZ_USB_RESERVED1  ] = STRINGIZER(REG_ZZ_USB_RESERVED1  ),// 0x1BC,
   ...
   [REG_ZZ_APPLY_MISC     ] = STRINGIZER(REG_ZZ_APPLY_MISC     ),// 0x28C,

   [REG_ZZ_APPLY_PRESET   ] = STRINGIZER(REG_ZZ_APPLY_PRESET   ),// 0x290,
   [REG_ZZ_PRESET_SEL     ] = STRINGIZER(REG_ZZ_PRESET_SEL     ),// 0x294,
   [REG_ZZ_PRESET_SEL_TXT ] = STRINGIZER(REG_ZZ_PRESET_SEL_TXT ),// 0x298,
   [REG_ZZ_DELETE_PRESET  ] = STRINGIZER(REG_ZZ_DELETE_PRESET  ),// 0x29C,
   ...
   [REG_ZZ_MOUNT_SD_0x76  ] = STRINGIZER(REG_ZZ_MOUNT_SD_0x76  ),// 0x310,
   [REG_ZZ_MOUNT_SD_ROOT  ] = STRINGIZER(REG_ZZ_MOUNT_SD_ROOT  ),// 0x314,
   [REG_ZZ_MONITOR_SWITCH ] = STRINGIZER(REG_ZZ_MONITOR_SWITCH ),// 0x318,
   ...
   [REG_ZZ_SEL_PRESET_TXT+0x00] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x700",
   [REG_ZZ_SEL_PRESET_TXT+0x04] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x704",
   [REG_ZZ_SEL_PRESET_TXT+0x08] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x708",
   [REG_ZZ_SEL_PRESET_TXT+0x0C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x70C",
   [REG_ZZ_SEL_PRESET_TXT+0x10] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x710",
   [REG_ZZ_SEL_PRESET_TXT+0x14] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x714",
   [REG_ZZ_SEL_PRESET_TXT+0x18] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x718",
   [REG_ZZ_SEL_PRESET_TXT+0x1C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x71C",
   [REG_ZZ_SEL_PRESET_TXT+0x20] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x720",
   [REG_ZZ_SEL_PRESET_TXT+0x24] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x724",
   [REG_ZZ_SEL_PRESET_TXT+0x28] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x728",
   [REG_ZZ_SEL_PRESET_TXT+0x2C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x72C",
   [REG_ZZ_SEL_PRESET_TXT+0x30] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x730",
   [REG_ZZ_SEL_PRESET_TXT+0x34] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x734",
   [REG_ZZ_SEL_PRESET_TXT+0x38] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x738",
   [REG_ZZ_SEL_PRESET_TXT+0x3C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x73C",
   [REG_ZZ_SEL_PRESET_TXT+0x40] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x740",
   [REG_ZZ_SEL_PRESET_TXT+0x44] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x744",
   [REG_ZZ_SEL_PRESET_TXT+0x48] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x748",
   [REG_ZZ_SEL_PRESET_TXT+0x4C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x74C",
   [REG_ZZ_SEL_PRESET_TXT+0x50] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x750",
   [REG_ZZ_SEL_PRESET_TXT+0x54] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x754",
   [REG_ZZ_SEL_PRESET_TXT+0x58] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x758",
   [REG_ZZ_SEL_PRESET_TXT+0x5C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x75C",
   [REG_ZZ_SEL_PRESET_TXT+0x60] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x760",
   [REG_ZZ_SEL_PRESET_TXT+0x64] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x764",
   [REG_ZZ_SEL_PRESET_TXT+0x68] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x768",
   [REG_ZZ_SEL_PRESET_TXT+0x6C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x76C",
   [REG_ZZ_SEL_PRESET_TXT+0x70] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x770",
   [REG_ZZ_SEL_PRESET_TXT+0x74] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x774",
   [REG_ZZ_SEL_PRESET_TXT+0x78] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x778",
   [REG_ZZ_SEL_PRESET_TXT+0x7C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x77C",
   [REG_ZZ_SEL_PRESET_TXT+0x80] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x780",
   [REG_ZZ_SEL_PRESET_TXT+0x84] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x784",
   [REG_ZZ_SEL_PRESET_TXT+0x88] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x788",
   [REG_ZZ_SEL_PRESET_TXT+0x8C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x78C",
   [REG_ZZ_SEL_PRESET_TXT+0x90] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x790",
   [REG_ZZ_SEL_PRESET_TXT+0x94] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x794",
   [REG_ZZ_SEL_PRESET_TXT+0x98] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x798",
   [REG_ZZ_SEL_PRESET_TXT+0x9C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x79C",

   [REG_ZZ_SEL_ADF_TXT+0x00] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x800",
   [REG_ZZ_SEL_ADF_TXT+0x04] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x804",
   [REG_ZZ_SEL_ADF_TXT+0x08] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x808",
   [REG_ZZ_SEL_ADF_TXT+0x0C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x80C",
   [REG_ZZ_SEL_ADF_TXT+0x10] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x810",
   [REG_ZZ_SEL_ADF_TXT+0x14] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x814",
   [REG_ZZ_SEL_ADF_TXT+0x18] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x818",
   [REG_ZZ_SEL_ADF_TXT+0x1C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x81C",
   [REG_ZZ_SEL_ADF_TXT+0x20] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x820",
   [REG_ZZ_SEL_ADF_TXT+0x24] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x824",
   [REG_ZZ_SEL_ADF_TXT+0x28] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x828",
   [REG_ZZ_SEL_ADF_TXT+0x2C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x82C",
   [REG_ZZ_SEL_ADF_TXT+0x30] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x830",
   [REG_ZZ_SEL_ADF_TXT+0x34] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x834",
   [REG_ZZ_SEL_ADF_TXT+0x38] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x838",
   [REG_ZZ_SEL_ADF_TXT+0x3C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x83C",
   [REG_ZZ_SEL_ADF_TXT+0x40] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x840",
   [REG_ZZ_SEL_ADF_TXT+0x44] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x844",
   [REG_ZZ_SEL_ADF_TXT+0x48] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x848",
   [REG_ZZ_SEL_ADF_TXT+0x4C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x84C",
   [REG_ZZ_SEL_ADF_TXT+0x50] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x850",
   [REG_ZZ_SEL_ADF_TXT+0x54] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x854",
   [REG_ZZ_SEL_ADF_TXT+0x58] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x858",
   [REG_ZZ_SEL_ADF_TXT+0x5C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x85C",
   [REG_ZZ_SEL_ADF_TXT+0x60] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x860",
   [REG_ZZ_SEL_ADF_TXT+0x64] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x864",
   [REG_ZZ_SEL_ADF_TXT+0x68] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x868",
   [REG_ZZ_SEL_ADF_TXT+0x6C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x86C",
   [REG_ZZ_SEL_ADF_TXT+0x70] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x870",
   [REG_ZZ_SEL_ADF_TXT+0x74] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x874",
   [REG_ZZ_SEL_ADF_TXT+0x78] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x878",
   [REG_ZZ_SEL_ADF_TXT+0x7C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x87C",
   [REG_ZZ_SEL_ADF_TXT+0x80] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x880",
   [REG_ZZ_SEL_ADF_TXT+0x84] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x884",
   [REG_ZZ_SEL_ADF_TXT+0x88] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x888",
   [REG_ZZ_SEL_ADF_TXT+0x8C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x88C",
   [REG_ZZ_SEL_ADF_TXT+0x90] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x890",
   [REG_ZZ_SEL_ADF_TXT+0x94] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x894",
   [REG_ZZ_SEL_ADF_TXT+0x98] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x898",
   [REG_ZZ_SEL_ADF_TXT+0x9C] = STRINGIZER(REG_ZZ_SEL_ADF_TXT ) " 0x89C",
