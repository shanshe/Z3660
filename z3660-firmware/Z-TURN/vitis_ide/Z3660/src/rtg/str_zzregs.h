...
char *zz_reg_offsets_string[]={
   ...
   [REG_ZZ_USB_PORTSC1    ] = STRINGIZER(REG_ZZ_USB_PORTSC1    ),// 0x1AC,

   [REG_ZZ_USB_CMD_OP     ] = STRINGIZER(REG_ZZ_USB_CMD_OP     ),// 0x1B0,
   [REG_ZZ_USB_STATUS     ] = STRINGIZER(REG_ZZ_USB_STATUS     ),// 0x1B4,
   [REG_ZZ_USB_READ0      ] = STRINGIZER(REG_ZZ_USB_READ0      ),// 0x1B8,
   ...
   [REG_ZZ_SEL_PRESET_TXT+0x5C] = STRINGIZER(REG_ZZ_SEL_PRESET_TXT ) " 0x65C",
