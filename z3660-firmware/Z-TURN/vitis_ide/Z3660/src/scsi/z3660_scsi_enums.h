...
enum piscsi_cmds {
   ...
   PISCSI_CMD_READ_ADDR1   = 0x20,
   PISCSI_CMD_READ_ADDR2   = 0x24,
   PISCSI_CMD_READ_ADDR3   = 0x28,
   PISCSI_CMD_READ_ADDR4   = 0x2C,
   ...
   PISCSI_CMD_BLOCKSIZE0   = 0x200,
   PISCSI_CMD_BLOCKSIZE1   = 0x204,
   PISCSI_CMD_BLOCKSIZE2   = 0x208,
   PISCSI_CMD_BLOCKSIZE3   = 0x20C,
   PISCSI_CMD_BLOCKSIZE4   = 0x210,
   PISCSI_CMD_BLOCKSIZE5   = 0x214,
   PISCSI_CMD_BLOCKSIZE6   = 0x218,
   PISCSI_CMD_BLOCKSIZE7   = 0x21C,
   PISCSI_CMD_BLOCKS0      = 0x220,
   PISCSI_CMD_BLOCKS1      = 0x224,
   PISCSI_CMD_BLOCKS2      = 0x228,
   PISCSI_CMD_BLOCKS3      = 0x22C,
   PISCSI_CMD_BLOCKS4      = 0x230,
   PISCSI_CMD_BLOCKS5      = 0x234,
   PISCSI_CMD_BLOCKS6      = 0x238,
   PISCSI_CMD_BLOCKS7      = 0x23C,
   PISCSI_CMD_WRITE_ADDR1  = 0x240,
   PISCSI_CMD_WRITE_ADDR2  = 0x244,
   PISCSI_CMD_WRITE_ADDR3  = 0x248,
   PISCSI_CMD_WRITE_ADDR4  = 0x24C,
   PISCSI_CMD_BLOCKSIZE10  = 0x250,
   PISCSI_CMD_BLOCKSIZE11  = 0x254,
   PISCSI_CMD_BLOCKSIZE12  = 0x258,
   PISCSI_CMD_BLOCKSIZE13  = 0x25C,
   PISCSI_CMD_BLOCKSIZE14  = 0x260,
   PISCSI_CMD_BLOCKSIZE15  = 0x264,
   PISCSI_CMD_BLOCKSIZE16  = 0x268,
   PISCSI_CMD_BLOCKSIZE17  = 0x26C,
   PISCSI_CMD_BLOCKS10     = 0x270,
   PISCSI_CMD_BLOCKS11     = 0x274,
   PISCSI_CMD_BLOCKS12     = 0x278,
   PISCSI_CMD_BLOCKS13     = 0x27C,
   PISCSI_CMD_BLOCKS14     = 0x280,
   PISCSI_CMD_BLOCKS15     = 0x284,
   PISCSI_CMD_BLOCKS16     = 0x288,
   PISCSI_CMD_BLOCKS17     = 0x28C,
   PISCSI_CMD_EXPBASE      = 0x290,
