...
#endif
#if 0
	   Xil_DCacheFlushRange((INTPTR)((uae_u8*)start), (uae_u8*)stop-(uae_u8*)start);
	   Xil_ICacheInvalidateRange((INTPTR)((uae_u8*)start), (uae_u8*)stop-(uae_u8*)start);
#else
	   // these are faster than xilinx's ones
	   arm_flush_cache((INTPTR)((uae_u8*)start), (uae_u8*)stop-(uae_u8*)start);
//	   arm_dcache_invalidate((INTPTR)((uae_u8*)start), (uae_u8*)stop-(uae_u8*)start);
	   arm_icache_invalidate((INTPTR)((uae_u8*)start), (uae_u8*)stop-(uae_u8*)start);
#endif
}
