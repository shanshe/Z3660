...
XClk_Wiz_Config XClk_Wiz_ConfigTable[XPAR_XCLK_WIZ_NUM_INSTANCES] =
{
	...
	{
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_DEVICE_ID,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_BASEADDR,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_ENABLE_CLOCK_MONITOR,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_ENABLE_USER_CLOCK0,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_ENABLE_USER_CLOCK1,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_ENABLE_USER_CLOCK2,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_ENABLE_USER_CLOCK3,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_REF_CLK_FREQ,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_USER_CLK_FREQ0,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_USER_CLK_FREQ1,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_USER_CLK_FREQ2,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_USER_CLK_FREQ3,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_PRECISION,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_ENABLE_PLL0,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_ENABLE_PLL1,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_PRIM_IN_FREQ,
		XPAR_PROCESSING_AV_SYSTEM_CLOCK_GENERATION_CLK_WIZ_1_NUM_OUT_CLKS
	},
	{
