...
set_property DRIVE 16 [get_ports BCLK_clk]
set_property DRIVE 16 [get_ports CLK90_clk]
set_property DRIVE 16 [get_ports CPUCLK_clk]
set_property DRIVE 16 [get_ports I2S_SCLK]
set_property DRIVE 16 [get_ports PCLK_clk]
set_property DRIVE 16 [get_ports nCLKEN_clk]
