...
<br>Also, in this version you can see that I have used a 3V3 DCDC converter, instead of old linear regulator on VR1. Board has both footprint in one. Please be careful with its connection.